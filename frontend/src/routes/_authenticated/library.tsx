  ...
  head: () => ({
    meta: [
      { title: "Biblioteca — Cognia AI" },
      {
        name: "description",
        content:
          "Todas as suas conversas, documentos e imagens gerados com a Cognia AI em um só lugar.",
      },
      { property: "og:title", content: "Biblioteca — Cognia AI" },
      {
        property: "og:description",
        content: "Conversas, documentos e imagens da sua assistente Cognia AI.",
      },
            ...
            {conversations.map((c) => (
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  {c.favorite && (
                    <Star className="w-3.5 h-3.5 ml-auto shrink-0 fill-primary text-primary" />
                  )}
                </div>
              </Link>
            ))}
          ...
          <div className="space-y-2">
            ...
            {!isLoading && docs.length === 0 && (
              <p className="text-sm text-muted-foreground">
                Nenhum documento ainda. Envie um arquivo no chat.
              </p>
            )}
          </div>
        )}
