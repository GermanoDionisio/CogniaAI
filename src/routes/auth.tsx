  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="flex justify-center mb-6"><CogniaLogo size={44} /></div>
        <div className="glass rounded-3xl p-8 shadow-[var(--shadow-elegant)]">
          <div className="text-center mb-6">
            <div className="w-12 h-12 rounded-2xl mx-auto mb-3 flex items-center justify-center" style={{ background: "var(--gradient-brand)" }}>
          ...
          <form onSubmit={submit} className="space-y-3">
            {mode === "signup" && (
              <input
                ...
                className="w-full rounded-xl bg-input px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-primary/40"
              />
            )}
            <input
              type="email"
