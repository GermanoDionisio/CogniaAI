...
export const ACCENTS: Record<AccentColor, { label: string; from: string; to: string; primary: string }> = {
  blue:   { label: "Azul elétrico", from: "oklch(0.68 0.19 265)", to: "oklch(0.66 0.22 305)", primary: "oklch(0.68 0.19 265)" },
  purple: { label: "Roxo real",     from: "oklch(0.62 0.25 305)", to: "oklch(0.66 0.20 340)", primary: "oklch(0.62 0.25 305)" },
  green:  { label: "Verde esmeralda", from: "oklch(0.70 0.18 155)", to: "oklch(0.72 0.16 190)", primary: "oklch(0.70 0.18 155)" },
  orange: { label: "Laranja solar", from: "oklch(0.75 0.18 55)",  to: "oklch(0.68 0.22 30)",  primary: "oklch(0.72 0.20 45)"  },
  pink:   { label: "Rosa neon",     from: "oklch(0.72 0.22 355)", to: "oklch(0.66 0.24 320)", primary: "oklch(0.70 0.22 350)" },
  cyan:   { label: "Ciano futurista", from: "oklch(0.75 0.15 210)", to: "oklch(0.70 0.18 240)", primary: "oklch(0.72 0.16 220)" },
};
